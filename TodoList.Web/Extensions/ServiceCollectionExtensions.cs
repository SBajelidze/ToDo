...
namespace TodoList.Web.Extensions
{
    public static class ServiceCollectionExtensions
    {
        ...
        {
            var connectionString = configuration.GetConnectionString("SqlServerConnection"); // Use the SQL Server connection string key from appsettings.json

            services.AddDbContext<ApplicationDbContext>(options =>
            {
                options.UseSqlServer(connectionString, x => x.MigrationsAssembly("TodoList.Core"));
            });
        }
